...
class User(db.Model):
    ...
    userid = db.Column(db.String(50), unique=True, nullable=True)
    password = db.Column(db.String(255), nullable=False)
    role = db.Column(db.String(20), nullable=False)
    # New: Add an expertise field for mentors (comma-separated string)
    expertise = db.Column(db.String(255), nullable=True, default='') # Example: "Python,Database,Frontend"
...
class Query(db.Model):
    ...
    # New: Add a tags field for queries (comma-separated string)
    tags = db.Column(db.String(255), nullable=True, default='') # Example: "Backend,Bug"
